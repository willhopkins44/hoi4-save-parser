...
output_file1 = open("parsed_save.json", "w")
output_file2 = open("parsed_save.txt", "w")

tokens = generate_JSON_tokens(save_file)
jsonData = format_tokens_to_JSON(tokens)
write_JSON_to_file(output_file1, jsonData)
write_JSON_to_file(output_file2, jsonData)
